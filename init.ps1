...
try {
    ...
    & $mkcert -install
    & $mkcert -key-file key.pem -cert-file cert.pem "xmcloudcm.localhost" "www.xmcloud.localhost"
...
# not using jss deploy for this solution
#Set-EnvFileVariable "JSS__DEPLOYMENT_SECRET" -Value $xmBuild.renderingHosts.xmpreview.jssDeploymentSecret
...
# RENDERING_HOST
Set-EnvFileVariable "RENDERING_HOST" -Value "www.xmcloud.localhost"
